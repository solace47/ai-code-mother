...
class AiCodeGeneratorServiceTest {
    ...
    void generateHtmlCode() {
        HtmlCodeResult result = aiCodeGeneratorService.generateHtmlCode("做个solace47的工作记录小工具, 代码行数在20行内");
        Assertions.assertNotNull(result);
    }

    @Test
    void generateMultiFileCode() {
        MultiFileCodeResult multiFileCode = aiCodeGeneratorService.generateMultiFileCode("做个solace47的to do list，代码行数在50行内");
